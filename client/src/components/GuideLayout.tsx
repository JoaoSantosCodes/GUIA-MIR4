...
import { Search, LogIn, Swords, BookOpen, Pickaxe, User as UserIcon, Coins, Home, Star, Skull, Trophy, TrendingUp, Moon, Sun, Castle, Gem, Calendar, Calculator, Layers, Package, Newspaper, Sparkles, Shield, Sword, ScrollText, Gem as GemIcon, Zap, Crown, MapPin, FlaskConical, Factory, Users, BookMarked, Target, Compass, ArrowRightLeft, Menu, X } from "lucide-react";
...
const SIDEBAR_GROUPS = [
  {
    ...
    items: [
      ...
      { key: "novidades", label: "Notícias", path: "/novidades", icon: Newspaper },
      { key: "calendario", label: "Calendário", path: "/calendario", icon: Calendar },
    ],
  },
  {
    label: "Guia de Personagem",
    items: [
      { key: "classes", label: "Classes", path: "/classes", icon: Swords },
      { key: "subclasses", label: "Subclasses & Skills", path: "/subclasses", icon: Layers },
      { key: "espiritos", label: "Espíritos", path: "/espiritos", icon: Sparkles },
      { key: "equipamentos", label: "Equipamentos & Geminação", path: "/equipamentos", icon: Shield },
      { key: "materiais", label: "Materiais & Crafting", path: "/materiais", icon: Package },
      { key: "selos", label: "Selos & Geminação", path: "/selos", icon: GemIcon },
    ],
  },
  {
    label: "Progressão",
    items: [
      { key: "codex", label: "Codex", path: "/codex", icon: BookOpen },
      { key: "farm", label: "Locais de Farm", path: "/farm", icon: Pickaxe },
      { key: "nivel", label: "Leveling", path: "/nivel", icon: TrendingUp },
      { key: "raids", label: "Raids e Bosses", path: "/raids", icon: Skull },
      { key: "misterios", label: "Mistérios", path: "/misterios", icon: BookMarked },
    ],
  },
  {
    label: "Sistemas Avançados",
    items: [
      { key: "tier-list", label: "Tier List Comunitária", path: "/tier-list", icon: Trophy },
      { key: "economia", label: "Economia", path: "/economia", icon: Coins },
      { key: "calculadora", label: "Calculadora Darksteel", path: "/calculadora", icon: Calculator },
      { key: "sabuk", label: "Sabuk & Guildas", path: "/sabuk", icon: Castle },
      { key: "faq", label: "FAQ Comunitária", path: "/faq", icon: ScrollText },
      { key: "placar", label: "Placar", path: "/placar", icon: Target },
    ],
  },
];

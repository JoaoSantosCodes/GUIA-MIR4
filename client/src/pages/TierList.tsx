...
import { ChevronUp, ChevronDown, Lock, RotateCcw, Users, UserRound, Info } from "lucide-react";
...
export default function TierList() {
  ...
  const startLogin = () => void (auth.user ? null : null);

  return (
    <div>
      <PageBanner
        title="Tier List de Classes"
        subtitle="Ranking comunitário das 8 classes oficiais do MIR4 por cenário. Vote para sugerir ajustes e personalize sua própria tier list."
